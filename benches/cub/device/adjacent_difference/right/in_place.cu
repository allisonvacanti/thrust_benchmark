...
static void basic(nvbench::state &state, nvbench::type_list<T>)
{
  ...
  cub::DeviceAdjacentDifference::SubtractRight(nullptr,
                                               temp_storage_size,
  ...
  state.exec([&](nvbench::launch &launch) {
    NVBENCH_CUDA_CALL(cub::DeviceAdjacentDifference::SubtractRight(
...
NVBENCH_BENCH_TYPES(basic, NVBENCH_TYPE_AXES(types))
  .set_name("cub::DeviceAdjacentDifference::SubtractRight (in-place)")
